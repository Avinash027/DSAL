...
cout << "\tEnter the Division:"; cin >> div;
...
int main()
{
int i, n, ch, ch1, rec, start, count, add, n1, add2, start2, n2, y, a, b, on, oname, add3, start3, n3,
y1,
add4, start4, n4;
...
cout << "\nRecord found";
add = f.tellg();
f.seekg(0, ios::beg); start =
f.tellg(); n1 = (add - start) /
(sizeof(t1));
...
cout << "\nName found";
add2 = f.tellg();
f.seekg(0, ios::beg); start2 =
f.tellg(); n2 = (add2 - start2) /
(sizeof(t1));
...
cout << "\n\tNumber found";
add3 = f.tellg();
f.seekg(0, ios::beg); start3 =
f.tellg(); n3 = (add3 - start3) /
(sizeof(t1));
...
cout << "\nName found";
add4 = f.tellg();
f.seekg(0, ios::beg); start4 =
f.tellg(); n4 = (add4 - start4) /
(sizeof(t1));
